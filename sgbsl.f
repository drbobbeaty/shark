...
c
c        abd     real(lda, n)
c                the output from sgbco ot sgbfa.
c
c        lda     integer
...
c        job     integer
c                = 0    to solve a*x = b
c                <> 0   to solve trans(a)*x = b, where trans(a)
c                       is the transpose of a.
c
c     on return
c
...
c        but is often caused by improper arguments or improper
...
c       10 continue
c
c     linpack. this verison dated 08/14/78
c     cleve boler, university of new mexico, argonne national lab.
c
