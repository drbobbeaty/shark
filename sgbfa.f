...
c                triangular matricies and u is upper triangular.
c
c        ipvt    integer(n)
c                in integer vactor of pivot indices.
c
c        info    integer
c                = 0  normal value
...
c           elements generated during triangularization.
...
c
      ...
      double precision t
c               don't interchange rows for this code
c     integer isamax
c
c
      m = ml + mu + 1
...
c
c       row eliminination with column indexing
c
